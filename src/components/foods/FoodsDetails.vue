<template>
    <div class="details">
      ...
      <div class="product_cons">
        <div class="image">
          <img width="320" :src="foods.good[this.index].image"/>
        </div>
        <div class="msg">
          <h2 class="name">{{foods.good[index].name}} {{foods.good[index].model}}</h2>
          <h3 class="resume">{{foods.good[index].resume}}</h3>
          <div class="price">
            <span class="center">￥{{foods.good[index].price}}</span>
          </div>
          <div class="small">
        ...
        <div class="guige">
          ...
          <div>规格:<span>{{foods.good[index].model}}</span></div>
